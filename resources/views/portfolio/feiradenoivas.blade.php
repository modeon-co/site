...
@section('og')
   <meta property="og:title" content="Sua marca é sua presença web">
    <meta property="og:description" content="Feira de Noivas - Serviço desenvolvido pela Modeon Devhouse de criação de site.">
    <meta property="og:url" content="http://www.modeon.co/portfolio/feiradenoivas">
                    ...
                    <div id="carousel" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner" role="listbox">
                        <div class="item active">
                          <img src="/img/portfolio/feiradenoivas/01.jpg" alt="Feira de Noivas">
                        </div>
                        <div class="item">
                          <img src="/img/portfolio/feiradenoivas/02.jpg" alt="Feira de Noivas">
                        </div>
                      </div>

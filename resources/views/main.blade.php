...
<html lang="{{ app()->getLocale() }}">
    ...
    <head>
        ...
        <meta name="description" content="Uma empresa que não está na internet não existe. A Modeon Devhouse resolve esse problema! A Modeon é uma empresa de desenvolvimento situada em Petrolina - PE." />
        ...
        <meta property="og:description" content="Uma empresa que não está na internet não existe. A Modeon Devhouse resolve esse problema! A Modeon é uma empresa de desenvolvimento situada em Petrolina - PE.">
